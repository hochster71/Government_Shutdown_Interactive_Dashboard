...
> This file covers **10 findings** across 3 categories that require developer attention.
...
- **Location:** _no specific file_
- **Details:** 2 issue(s) that appeared in prior pipeline runs are still present: .env file committed to repository; Very large diff.
...
- **Details:** This critical finding is a direct buyer blocker for Defense / Government Cybersecurity sales. Environment file ".env.example" was included in the commit. It may contain live secrets.
...
- **Location:** _no specific file_
- **Details:** This critical finding is a direct buyer blocker for Defense / Government Cybersecurity sales. 1 critical issue(s) were detected by upstream agents: .env file committed to repository
- **Steps:** Resolve all critical findings before this branch can be merged or deployed.

#### 🟠 HIGH — [Revenue Blocker] 2 upstream agent(s) failed
- **Location:** _no specific file_
- **Details:** This high finding is a direct buyer blocker for Defense / Government Cybersecurity sales. Agents that did not pass: security, dast.
- **Steps:** Investigate failures in the listed agents before retrying.
